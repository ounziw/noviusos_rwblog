CREATE TABLE IF NOT EXISTS `nos_rwblog_category` (
...
CREATE TABLE IF NOT EXISTS `nos_rwblog_category_post` (
  `post_id` int(11) NOT NULL,
  `cat_id` int(11) NOT NULL,
  PRIMARY KEY (`post_id`,`cat_id`)
) DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `nos_rwblog_post` (
...
CREATE TABLE IF NOT EXISTS `nos_rwblog_tag` (
...
CREATE TABLE IF NOT EXISTS `nos_rwblog_tag_post` (
